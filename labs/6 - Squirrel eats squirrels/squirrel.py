...
# Барање 1. Промена на големината на прозорецот
...
# Барање 2. Нови две посебни променливи за координатите
CAMERASLACK_X = 120
CAMERASLACK_Y = 120
...
# Барање 5. Додадов нова променлива која ќе го чува резултатот
SCORE = 0
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, L_SQUIR_IMG, R_SQUIR_IMG, GRASSIMAGES, SCORE
...
# Барање 5. Додадена нова функција за прикажување на резултатот
...
def render_score(score: int):
    ...
    scoreRect.topright = (WINWIDTH, 20)
