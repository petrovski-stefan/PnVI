...
# Барање 1: Го променив бројот на редиците и колоните
BOARDWIDTH = 3  # number of columns in the board
BOARDHEIGHT = 3  # number of rows in the board

# Барање 2: Ја намалив големината на секое поле со цел да има место  и за копчето Help и за другите полиња (барање 1)
TILESIZE = 40
WINDOWWIDTH = 640
WINDOWHEIGHT = 480
FPS = 30
...
def main():
    # Барање 2: Додадов 2 променливи за новото копче Help:   HELP_SURF, HELP_RECT
    ...
    # Барање 2: Копче со текст „Help“ и ги одредив неговите координати
...
def drawBoard(board, message):
    ...
    # Барање 2: Рендерирање на копчето Help
