...
FPS = 25
# Барање 1. Исто така го зголемив и прозорецот
WINDOWWIDTH = 800
WINDOWHEIGHT = 600
BOXSIZE = 20
# Барање 1. Промена на вредностите на BOARDWIDTH и BOARDHEIGHT
BOARDWIDTH = 20
BOARDHEIGHT = 40
BLANK = '.'
...
# Барање 2. Додавање на нови форми со 2 и 3 коцки

THREE_BOXES_SHAPE_TEMPLATE = [['.....',
                               '.....',
                               '.OOO.',
                               '.....',
                               '.....'],
...
PIECES = {'S': S_SHAPE_TEMPLATE,
          ...
          # Барање 2. Додавање на новите форми во речникот
          '3': THREE_BOXES_SHAPE_TEMPLATE,
          '2': TWO_BOXES_SHAPE_TEMPLATE}
...
def calculateLevelAndFallFreq(score):
    ...
    # Барање 4. Логика за брзина на паѓање. Ако бројот на комплетирани редови е парен, тогаш
    # формите паѓаат побрзо, а за непарен - побавно.
    ...
    # Барање 4. Почетна брзина (кога резултатот е 0)
    fallFreq = 0.27
