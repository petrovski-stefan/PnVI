...
# Барање 1. Промена на вредноста на променливата
...
def main():
    ...
    while True:  # main game loop
        ...
        # Барање 2. Промена во условот од ('solved', 'next') во ('solved')
        if result in ('solved'):
            ...
            # Барање 2. Бидејќи исто така со кликање B од прво ниво може да се стигне „напред“ до последното,
            # направив промена во условот со цел да се оневозможи одење назад после првото ниво.
...
def runLevel(levels, levelNum):
    ...
    # Барање 4. Додавање на 2 нови променливи кои ќе означуваат почеток на времето и изминато време
    ...
    while True:  # main game loop
        ...
        for event in pygame.event.get():  # event handling loop
            if event.type == QUIT:
                ...
                # Барање 2. Бришење на функционалноста за премин на следно ниво (искоментиран код)
                # elif event.key == K_n:
                #     return 'next'
                elif event.key == K_b:
                    return 'back'
            ...
            # Барање 4. Пресметување на изминатото време
        ...
        # Барање 4. Прикажување на изминатото време
